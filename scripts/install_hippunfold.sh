...
# Cleanup old images
OLD_IMG=($(ls ${INSTALL_PREFIX}/hippunfold_*.sif 2>/dev/null || true))
...
IMG_PREFIX="${INSTALL_PREFIX}/hippunfold_${HIPPUNFOLD_VERSION}.sif"
apptainer build ${IMG_PREFIX} docker://khanlab/hippunfold:${HIPPUNFOLD_VERSION}
...
# hippunfold
export PATH=\"${INSTALL_ROOT_PREFIX}/hippunfold:\${PATH}\"
"
