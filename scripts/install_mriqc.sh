...
INSTALL_PREFIX="$(eval "echo ${INSTALL_ROOT_PREFIX}/mriqc")"
MRIQC_VERSION=${MRIQC_VERSION:-25.0.0rc0}
# apptainer
...
# Cleanup old images
OLD_IMG=($(ls ${INSTALL_PREFIX}/mriqc_*.sif 2>/dev/null || true))
...
IMG_PREFIX="${INSTALL_PREFIX}/mriqc_v${MRIQC_VERSION}.sif"
apptainer build ${IMG_PREFIX} docker://nipreps/mriqc:${MRIQC_VERSION}
...
# mriqc
export PATH=\"${INSTALL_ROOT_PREFIX}/mriqc:\${PATH}\"
"
