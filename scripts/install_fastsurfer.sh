...
# Cleanup old images
OLD_IMG=($(ls ${INSTALL_PREFIX}/fastsurfer_*.sif 2>/dev/null || true))
...
IMG_PREFIX="${INSTALL_PREFIX}/fastsurfer_$(echo ${FASTSURFER_VERSION} | sed 's/-/_/g').sif"
apptainer build ${IMG_PREFIX} docker://deepmi/fastsurfer:${FASTSURFER_VERSION}
...
# fastsurfer
export PATH=\"${INSTALL_ROOT_PREFIX}/fastsurfer:\${PATH}\"
"
