...
# Cleanup old images
OLD_IMG=($(ls ${INSTALL_PREFIX}/xcp-d_*.sif 2>/dev/null || true))
...
IMG_PREFIX="${INSTALL_PREFIX}/xcp-d_v${XCPD_VERSION}.sif"
apptainer build ${IMG_PREFIX} docker:pennlinc/xcp_d:${XCPD_VERSION}
...
# xcp-d
export PATH=\"${INSTALL_ROOT_PREFIX}/xcp-d:\${PATH}\"
"
